...
const advantageList: AdvantageList[] = [
  ...
  },
  {
    ...
    desc: 'Chúng tôi là đơn vị duy nhất tại Đà Nẵng cam kết về chất lượng chương trình. Nếu có bất kỳ điều gì khiến quý khách không hài lòng, chúng tôi cam kết hoàn tiền từ 50-100% mà không hỏi thêm bất kỳ điều gì.',
  },
];
