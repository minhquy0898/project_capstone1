            ...
            <div>
                <Carousel showThumbs={false} autoPlay={true} className="shadow-2xl mb-10">
                    <div className="h-[350px] ">
                        ...
                        <p className=" italic mt-2">Đà Nẵng Event Công ty tổ chức sự kiện cho thuê các thiết bị âm thanh , ánh sáng</p>
                        <p className=" italic">hàng đầu tại khu vực Đà Nẵng</p>
                    </div>
                    <div>
                        <img className=" mt-12" src={capture} style={{ width: '100px' }} />
                        <div className="flex justify-center ">
