...
function Footer() {
  return (
    // <footer className="bg-white w-full flex justify-center dark:bg-gray-900 border-t-1">
      ...
      <div className="text-center flex justify-center items-center mx-auto bg-white h-[230px] mt-20 p-10 rounded-lg">
        <div className=" mr-16 w-[33.33%]">
          ...
          <div className=" text-left">
            <div className="mt-2">Địa chỉ : Số 123 , phường Hòa Hiệp Nam , quận Liên Chiểu , Đà Nẵng</div>
        ...
        <div className=" mr-16 w-[33.33%] mb-8">
          <p className=" uppercase text-xl text-violet-900 font-bold text-left">Tài khoản ngân hàng</p>
          <div className="text-left">
            <div className="mt-2">Người nhận : DUONG MINH QUY</div>
            <div className="mt-2">Số tài khoản : 0000717799266</div>
        ...
        <div className="">
          ...
          <div className="text-left">
            ...
            <div className="mt-2">MST : 123456789</div>
            <div className="mt-2">Người đại diện : Dương Minh Quý</div>
          </div>
          <div>
            <div className=" bg-blue-700 p-2 mt-2 rounded-xl text-white">Gọi ngay : 0898.240.032</div>
          </div>
        </div>
      </div>
    </div>
