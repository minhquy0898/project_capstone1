      ...
      <section className="container mx-auto mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <div>CÔNG TY TNHH TỔ CHỨC SỰ KIỆN ĐÀ NẴNG Giấy chứng nhận số 0912347898 do Sở kế hoạch và Đầu tư Đà Nẵng cung cấp</div>
            <div className='mt-6'>ĐÀ NẴNG EVENT</div>
            <div className='mt-6'>Liên hệ tổ chức sự kiện : 0898240032</div>
            <div className='mt-6'>Email : danangevent@gmail.com</div>
          </div>
        ...
        <p className='uppercase font-bold text-blue-500 text-3xl mb-6'> Công ty tnhh tổ chức sự kiện đà nẵng</p>
        <div className='flex'>
